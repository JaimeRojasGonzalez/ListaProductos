...
<body>
	<header id="idHeader">
		<nav id="menu" class="navbar navbar-expand-lg navbar-dark bg-dark">
			<a class="navbar-brand" href="#">Producto Limpieza</a>
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu"
							...
							<a class="dropdown-item" id="idMenuListaProductos" href="#">Lista
								Productos</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#"
						...
						<div class="dropdown-menu"
							aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" id="idMenuListaCategorias" href="#">Lista
								Categorias</a>
						</div></li>
				</ul>
			</div>
	...
	<div id="idContenido" class="container">
		<h1 class="text-center mt-4">Bienvenidos a Productos de Limpieza</h1>
	</div>
